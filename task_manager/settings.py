...
EMAIL_HOST_USER = os.environ.get("EMAIL_HOST_USER", "bhowmiksabuj786@gmail.com")
EMAIL_HOST_PASSWORD = os.environ.get("EMAIL_HOST_PASSWORD", "tzdv nsug iqzs oyof")  # Gmail App Password
