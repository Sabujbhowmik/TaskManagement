...
def admin_teacher_list(request):
    """
    Admin-only view: /admin-panel/teachers/
    Uses the shared teacher_list.html template.
    """
...
def admin_student_list(request):
    """
    Admin-only view: /admin-panel/students/
    Uses the shared student_list.html template.
    """
    students = CustomUser.objects.filter(role='Student')
