...
class CustomUser(AbstractUser):
    ...
    def set_otp(self, otp):
        self.otp = otp
        self.otp_created_at = timezone.now()  # timezone-aware
        self.save()

    def verify_otp(self, otp):
        # If no OTP or no timestamp stored
...
class Task(models.Model):
    ...
    # DateField is fine, no timezone issue here
    ...
    # ✅ This will always be timezone-aware when USE_TZ = True
...
# ✅ TaskFile Model (for multiple file attachments)
